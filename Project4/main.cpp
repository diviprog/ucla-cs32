...
//    }
    ...
    GeoDatabase geodb;
    if (!geodb.load("/Users/devanshmishra/Desktop/Top of the food chain/Devansh/UCLA/Classes/W24/CS32/Project4/Project4/mapdata.txt"))
    {
    ...
    Stops stops;
    if (!stops.load("/Users/devanshmishra/Desktop/Top of the food chain/Devansh/UCLA/Classes/W24/CS32/Project4/Project4/stops.txt"))
    {
